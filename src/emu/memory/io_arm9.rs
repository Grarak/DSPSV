...
use crate::emu::emu::{get_cm, get_cm_mut, get_common_mut, get_cpu_regs, get_cpu_regs_mut, get_mem, get_mem_mut, Emu};
    ...
    pub fn read<T: Convert>(&mut self, addr_offset: u32, emu: &mut Emu) -> T {
        ...
        while (index - 3) < mem::size_of::<T>() {
            io_ports_read!(match addr_offset + (index - 3) as u32 {
                ...
                io16(0x48) => common.gpu.gpu_2d_a.get_win_in(),
                io16(0x4A) => common.gpu.gpu_2d_a.get_win_out(),
                io16(0x50) => common.gpu.gpu_2d_a.get_bld_cnt(),
                io16(0x52) => common.gpu.gpu_2d_a.get_bld_alpha(),
                io16(0x60) => common.gpu.gpu_3d_renderer.get_disp_3d_cnt(),
                ...
                io32(0x600) => common.gpu.gpu_3d.get_gx_stat(),
                io32(0x604) => todo!(),
                io32(0x620) => todo!(),
                io32(0x624) => todo!(),
                io32(0x628) => todo!(),
                ...
                io16(0x632) => todo!(),
                io16(0x634) => todo!(),
                io32(0x640) => common.gpu.gpu_3d.get_clip_mtx_result(0),
                io32(0x644) => common.gpu.gpu_3d.get_clip_mtx_result(1),
                io32(0x648) => common.gpu.gpu_3d.get_clip_mtx_result(2),
                io32(0x64C) => common.gpu.gpu_3d.get_clip_mtx_result(3),
                io32(0x650) => common.gpu.gpu_3d.get_clip_mtx_result(4),
                io32(0x654) => common.gpu.gpu_3d.get_clip_mtx_result(5),
                io32(0x658) => common.gpu.gpu_3d.get_clip_mtx_result(6),
                io32(0x65C) => common.gpu.gpu_3d.get_clip_mtx_result(7),
                io32(0x660) => common.gpu.gpu_3d.get_clip_mtx_result(8),
                io32(0x664) => common.gpu.gpu_3d.get_clip_mtx_result(9),
                io32(0x668) => common.gpu.gpu_3d.get_clip_mtx_result(10),
                io32(0x66C) => common.gpu.gpu_3d.get_clip_mtx_result(11),
                io32(0x670) => common.gpu.gpu_3d.get_clip_mtx_result(12),
                io32(0x674) => common.gpu.gpu_3d.get_clip_mtx_result(13),
                io32(0x678) => common.gpu.gpu_3d.get_clip_mtx_result(14),
                io32(0x67C) => common.gpu.gpu_3d.get_clip_mtx_result(15),
                io32(0x680) => common.gpu.gpu_3d.get_vec_mtx_result(0),
                io32(0x684) => common.gpu.gpu_3d.get_vec_mtx_result(1),
                io32(0x688) => common.gpu.gpu_3d.get_vec_mtx_result(2),
                io32(0x68C) => common.gpu.gpu_3d.get_vec_mtx_result(3),
                io32(0x690) => common.gpu.gpu_3d.get_vec_mtx_result(4),
                io32(0x694) => common.gpu.gpu_3d.get_vec_mtx_result(5),
                io32(0x698) => common.gpu.gpu_3d.get_vec_mtx_result(6),
                io32(0x69C) => common.gpu.gpu_3d.get_vec_mtx_result(7),
                io32(0x6A0) => common.gpu.gpu_3d.get_vec_mtx_result(8),
                ...
                io16(0x1048) => common.gpu.gpu_2d_b.get_win_in(),
                io16(0x104A) => common.gpu.gpu_2d_b.get_win_out(),
    ...
    pub fn write<T: Convert>(&mut self, addr_offset: u32, value: T, emu: &mut Emu) {
        ...
        while (index - 3) < bytes.len() {
            io_ports_write!(match addr_offset + (index - 3) as u32 {
                ...
                io16(0x60) => common.gpu.gpu_3d_renderer.set_disp_3d_cnt(mask, value),
                ...
                io16(0x334) => common.gpu.gpu_3d_renderer.set_edge_color(2, mask, value),
                io16(0x336) => common.gpu.gpu_3d_renderer.set_edge_color(3, mask, value),
                io16(0x338) => common.gpu.gpu_3d_renderer.set_edge_color(4, mask, value),
                io16(0x33A) => common.gpu.gpu_3d_renderer.set_edge_color(5, mask, value),
                io16(0x33C) => common.gpu.gpu_3d_renderer.set_edge_color(6, mask, value),
                io16(0x33E) => common.gpu.gpu_3d_renderer.set_edge_color(7, mask, value),
                io32(0x350) => common.gpu.gpu_3d_renderer.set_clear_color(mask, value),
                io16(0x354) => common.gpu.gpu_3d_renderer.set_clear_depth(mask, value),
                io32(0x358) => common.gpu.gpu_3d_renderer.set_fog_color(mask, value),
                io16(0x35C) => common.gpu.gpu_3d_renderer.set_fog_offset(mask, value),
                io8(0x360) => common.gpu.gpu_3d_renderer.set_fog_table(0, value),
                io8(0x361) => common.gpu.gpu_3d_renderer.set_fog_table(1, value),
                io8(0x362) => common.gpu.gpu_3d_renderer.set_fog_table(2, value),
                io8(0x363) => common.gpu.gpu_3d_renderer.set_fog_table(3, value),
                io8(0x364) => common.gpu.gpu_3d_renderer.set_fog_table(4, value),
                io8(0x365) => common.gpu.gpu_3d_renderer.set_fog_table(5, value),
                io8(0x366) => common.gpu.gpu_3d_renderer.set_fog_table(6, value),
                io8(0x367) => common.gpu.gpu_3d_renderer.set_fog_table(7, value),
                io8(0x368) => common.gpu.gpu_3d_renderer.set_fog_table(8, value),
                io8(0x369) => common.gpu.gpu_3d_renderer.set_fog_table(9, value),
                io8(0x36A) => common.gpu.gpu_3d_renderer.set_fog_table(10, value),
                io8(0x36B) => common.gpu.gpu_3d_renderer.set_fog_table(11, value),
                io8(0x36C) => common.gpu.gpu_3d_renderer.set_fog_table(12, value),
                io8(0x36D) => common.gpu.gpu_3d_renderer.set_fog_table(13, value),
                io8(0x36E) => common.gpu.gpu_3d_renderer.set_fog_table(14, value),
                io8(0x36F) => common.gpu.gpu_3d_renderer.set_fog_table(15, value),
                io8(0x370) => common.gpu.gpu_3d_renderer.set_fog_table(16, value),
                io8(0x371) => common.gpu.gpu_3d_renderer.set_fog_table(17, value),
                io8(0x372) => common.gpu.gpu_3d_renderer.set_fog_table(18, value),
                io8(0x373) => common.gpu.gpu_3d_renderer.set_fog_table(19, value),
                io8(0x374) => common.gpu.gpu_3d_renderer.set_fog_table(20, value),
                io8(0x375) => common.gpu.gpu_3d_renderer.set_fog_table(21, value),
                io8(0x376) => common.gpu.gpu_3d_renderer.set_fog_table(22, value),
                io8(0x377) => common.gpu.gpu_3d_renderer.set_fog_table(23, value),
                io8(0x378) => common.gpu.gpu_3d_renderer.set_fog_table(24, value),
                io8(0x379) => common.gpu.gpu_3d_renderer.set_fog_table(25, value),
                io8(0x37A) => common.gpu.gpu_3d_renderer.set_fog_table(26, value),
                io8(0x37B) => common.gpu.gpu_3d_renderer.set_fog_table(27, value),
                io8(0x37C) => common.gpu.gpu_3d_renderer.set_fog_table(28, value),
                io8(0x37D) => common.gpu.gpu_3d_renderer.set_fog_table(29, value),
                io8(0x37E) => common.gpu.gpu_3d_renderer.set_fog_table(30, value),
                io8(0x37F) => common.gpu.gpu_3d_renderer.set_fog_table(31, value),
                io16(0x380) => common.gpu.gpu_3d_renderer.set_toon_table(0, mask, value),
                io16(0x382) => common.gpu.gpu_3d_renderer.set_toon_table(1, mask, value),
                io16(0x384) => common.gpu.gpu_3d_renderer.set_toon_table(2, mask, value),
                io16(0x386) => common.gpu.gpu_3d_renderer.set_toon_table(3, mask, value),
                io16(0x388) => common.gpu.gpu_3d_renderer.set_toon_table(4, mask, value),
                io16(0x38A) => common.gpu.gpu_3d_renderer.set_toon_table(5, mask, value),
                io16(0x38C) => common.gpu.gpu_3d_renderer.set_toon_table(6, mask, value),
                io16(0x38E) => common.gpu.gpu_3d_renderer.set_toon_table(7, mask, value),
                io16(0x390) => common.gpu.gpu_3d_renderer.set_toon_table(8, mask, value),
                io16(0x392) => common.gpu.gpu_3d_renderer.set_toon_table(9, mask, value),
                io16(0x394) => common.gpu.gpu_3d_renderer.set_toon_table(10, mask, value),
                io16(0x396) => common.gpu.gpu_3d_renderer.set_toon_table(11, mask, value),
                io16(0x398) => common.gpu.gpu_3d_renderer.set_toon_table(12, mask, value),
                io16(0x39A) => common.gpu.gpu_3d_renderer.set_toon_table(13, mask, value),
                io16(0x39C) => common.gpu.gpu_3d_renderer.set_toon_table(14, mask, value),
                io16(0x39E) => common.gpu.gpu_3d_renderer.set_toon_table(15, mask, value),
                io16(0x3A0) => common.gpu.gpu_3d_renderer.set_toon_table(16, mask, value),
                io16(0x3A2) => common.gpu.gpu_3d_renderer.set_toon_table(17, mask, value),
                io16(0x3A4) => common.gpu.gpu_3d_renderer.set_toon_table(18, mask, value),
                io16(0x3A6) => common.gpu.gpu_3d_renderer.set_toon_table(19, mask, value),
                io16(0x3A8) => common.gpu.gpu_3d_renderer.set_toon_table(20, mask, value),
                io16(0x3AA) => common.gpu.gpu_3d_renderer.set_toon_table(21, mask, value),
                io16(0x3AC) => common.gpu.gpu_3d_renderer.set_toon_table(22, mask, value),
                io16(0x3AE) => common.gpu.gpu_3d_renderer.set_toon_table(23, mask, value),
                io16(0x3B0) => common.gpu.gpu_3d_renderer.set_toon_table(24, mask, value),
                io16(0x3B2) => common.gpu.gpu_3d_renderer.set_toon_table(25, mask, value),
                io16(0x3B4) => common.gpu.gpu_3d_renderer.set_toon_table(26, mask, value),
                io16(0x3B6) => common.gpu.gpu_3d_renderer.set_toon_table(27, mask, value),
                io16(0x3B8) => common.gpu.gpu_3d_renderer.set_toon_table(28, mask, value),
                io16(0x3BA) => common.gpu.gpu_3d_renderer.set_toon_table(29, mask, value),
                io16(0x3BC) => common.gpu.gpu_3d_renderer.set_toon_table(30, mask, value),
                io16(0x3BE) => common.gpu.gpu_3d_renderer.set_toon_table(31, mask, value),
                io32(0x400) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x404) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x408) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x40C) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x410) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x414) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x418) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x41C) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x420) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x424) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x428) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x42C) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x430) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x434) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x438) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x43C) => common.gpu.gpu_3d.set_gx_fifo(mask, value, emu),
                io32(0x440) => common.gpu.gpu_3d.set_mtx_mode(mask, value, emu),
                io32(0x444) => common.gpu.gpu_3d.set_mtx_push(mask, value, emu),
                io32(0x448) => common.gpu.gpu_3d.set_mtx_pop(mask, value, emu),
                io32(0x44C) => common.gpu.gpu_3d.set_mtx_store(mask, value, emu),
                io32(0x450) => common.gpu.gpu_3d.set_mtx_restore(mask, value, emu),
                io32(0x454) => common.gpu.gpu_3d.set_mtx_identity(mask, value, emu),
                io32(0x458) => common.gpu.gpu_3d.set_mtx_load44(mask, value, emu),
                io32(0x45C) => common.gpu.gpu_3d.set_mtx_load43(mask, value, emu),
                io32(0x460) => common.gpu.gpu_3d.set_mtx_mult44(mask, value, emu),
                io32(0x464) => common.gpu.gpu_3d.set_mtx_mult43(mask, value, emu),
                io32(0x468) => common.gpu.gpu_3d.set_mtx_mult33(mask, value, emu),
                io32(0x46C) => common.gpu.gpu_3d.set_mtx_scale(mask, value, emu),
                io32(0x470) => common.gpu.gpu_3d.set_mtx_trans(mask, value, emu),
                io32(0x480) => common.gpu.gpu_3d.set_color(mask, value, emu),
                io32(0x484) => common.gpu.gpu_3d.set_normal(mask, value, emu),
                io32(0x488) => common.gpu.gpu_3d.set_tex_coord(mask, value, emu),
                io32(0x48C) => common.gpu.gpu_3d.set_vtx16(mask, value, emu),
                io32(0x490) => common.gpu.gpu_3d.set_vtx10(mask, value, emu),
                io32(0x494) => common.gpu.gpu_3d.set_vtx_x_y(mask, value, emu),
                io32(0x498) => common.gpu.gpu_3d.set_vtx_x_z(mask, value, emu),
                io32(0x49C) => common.gpu.gpu_3d.set_vtx_y_z(mask, value, emu),
                io32(0x4A0) => common.gpu.gpu_3d.set_vtx_diff(mask, value, emu),
                io32(0x4A4) => common.gpu.gpu_3d.set_polygon_attr(mask, value, emu),
                io32(0x4A8) => common.gpu.gpu_3d.set_tex_image_param(mask, value, emu),
                io32(0x4AC) => common.gpu.gpu_3d.set_pltt_base(mask, value, emu),
                io32(0x4C0) => common.gpu.gpu_3d.set_dif_amb(mask, value, emu),
                io32(0x4C4) => common.gpu.gpu_3d.set_spe_emi(mask, value, emu),
                io32(0x4C8) => common.gpu.gpu_3d.set_light_vector(mask, value, emu),
                io32(0x4CC) => common.gpu.gpu_3d.set_light_color(mask, value, emu),
                io32(0x4D0) => common.gpu.gpu_3d.set_shininess(mask, value, emu),
                io32(0x500) => common.gpu.gpu_3d.set_begin_vtxs(mask, value, emu),
                io32(0x504) => common.gpu.gpu_3d.set_end_vtxs(mask, value, emu),
                io32(0x540) => common.gpu.gpu_3d.set_swap_buffers(mask, value, emu),
                io32(0x580) => common.gpu.gpu_3d.set_viewport(mask, value, emu),
                io32(0x5C0) => common.gpu.gpu_3d.set_box_test(mask, value, emu),
                io32(0x5C4) => common.gpu.gpu_3d.set_pos_test(mask, value, emu),
                io32(0x5C8) => common.gpu.gpu_3d.set_vec_test(mask, value, emu),
                io32(0x600) => common.gpu.gpu_3d.set_gx_stat(mask, value),
